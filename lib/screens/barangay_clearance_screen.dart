...
class BarangayClearanceScreen extends StatefulWidget {
  const BarangayClearanceScreen({super.key});

  @override
  State<BarangayClearanceScreen> createState() =>
      _BarangayClearanceScreenState();
}

class _BarangayClearanceScreenState extends State<BarangayClearanceScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      await NotificationService.createNotification(
        userId: user.uid,
        title: 'Barangay Clearance request received',
        body:
            'Your Barangay Clearance request has been submitted and is now pending review.',
        type: 'request',
        relatedId: docRef.id,
      );
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Barangay Clearance request submitted')),
      );
          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                _buildField('Purpose', _purposeController, fieldBg),
