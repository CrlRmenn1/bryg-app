...
class ResidencyRequestScreen extends StatefulWidget {
  ...
  @override
  State<ResidencyRequestScreen> createState() => _ResidencyRequestScreenState();
}
...
class _ResidencyRequestScreenState extends State<ResidencyRequestScreen> {
  ...
  final _yearsController = TextEditingController(); // years of residency
  ...
  Future<void> _submit() async {
    ...
    try {
      final docRef =
        ...
        'yearsOfResidency': _yearsController.text.trim(),
        'status': 'pending',
      ...
      await NotificationService.createNotification(
        ...
        body:
            'Your Residency request has been submitted and is now pending review.',
        type: 'request',
        relatedId: docRef.id,
      );
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Residency request submitted')),
      );
          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                _buildField('Years of Residency', _yearsController, fieldBg),
